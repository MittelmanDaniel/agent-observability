...
async function migrate() {
    ...
    await client.indices.create({
      ...
      mappings: {
        properties: {
          ...
          task: { type: "keyword" as const },
          status: { type: "keyword" as const },
          started_at: { type: "date" as const },
          ended_at: { type: "date" as const },
    ...
    await client.indices.create({
      ...
      mappings: {
        properties: {
          ...
          ts: { type: "date" as const },
          type: { type: "keyword" as const },
          actor: { type: "keyword" as const },
          content: { type: "text" as const, index: true },
  ...
  const sectionsMapping = {
    properties: {
      id: { type: "keyword" as const },
      run_id: { type: "keyword" as const },
      start_idx: { type: "integer" as const },
      end_idx: { type: "integer" as const },
      label: { type: "text" as const, fields: { keyword: { type: "keyword" as const } } },
      what_happened: { type: "text" as const },
      verdict: { type: "keyword" as const },
      root_cause_guess: { type: "text" as const },
      fix_suggestion: { type: "text" as const },
